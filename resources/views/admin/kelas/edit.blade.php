...
@csrf @method('PUT')
<div class='mb-4'><label>Nama Kelas</label><input type='text' name='nama_kelas' value='{{ $data->nama_kelas }}' class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-b border-slate-100/80lue-500 focus:ring-blue-500 sm:text-sm"></div>
