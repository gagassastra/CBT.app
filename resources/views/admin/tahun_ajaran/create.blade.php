...
@csrf
<div class='mb-4'><label>Tahun Ajaran</label><input type='text' name='tahun_ajaran' class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-b border-slate-100/80lue-500 focus:ring-blue-500 sm:text-sm"></div>
